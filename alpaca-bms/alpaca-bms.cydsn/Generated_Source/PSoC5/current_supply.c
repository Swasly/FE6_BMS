...
*
* \funcusage
*  \snippet current_supply_SUT.c usage_current_supply_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet current_supply_SUT.c usage_current_supply_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet current_supply_SUT.c usage_current_supply_Read  
*******************************************************************************/
...
* preferred current_supply_Read() API because the 
* current_supply_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet current_supply_SUT.c usage_current_supply_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: current_supply_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use current_supply_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - current_supply_0_INTR       (First pin in the list)
    *  - current_supply_1_INTR       (Second pin in the list)
    *  - ...
    *  - current_supply_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet current_supply_SUT.c usage_current_supply_SetInterruptMode
    *******************************************************************************/
    void current_supply_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & current_supply_0_INTR) != 0u) 
		{ 
			 current_supply_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet current_supply_SUT.c usage_current_supply_ClearInterrupt
    *******************************************************************************/
